...
void head_nav_table(){
    ...
    fprintf(html_arq, "<!DOCTYPE html><html lang=\"pt-br\"><head><title>Tempo de Ordena��o</title><meta charset=\"UTF-8\">");
    ...
    // nav
    fprintf(html_arq, "<nav class=\"navbar sticky-top navbar-expand-lg  d-flex \"> <div class=\"container-fluid\"> <a class=\"navbar-brand\" href=\"index.html\">Tempo de Execu��o</a>");
    ...
    fprintf(html_arq, "<div class=\" d-flex justify-content-center mt-5\"><h3>Algoritmos de Ordena��o</h3></div>");
    // table
    fprintf(html_arq, "<div class=\"container mt-3 col-12 \" >");
    fprintf(html_arq, "<table class=\"table table-borderless\"><thead><tr ><th scope=\"col\">Posi��es</th><th scope=\"col\" ><a class=\"table-link\" href = \"https://blog.betrybe.com/tecnologia/bubble-sort-tudo-sobre/\">Bubble Sort</a></th><th scope=\"col\"><a class=\"table-link\" href = \"https://joaoarthurbm.github.io/eda/posts/selection-sort/\">Selection Sort</a></th><th scope=\"col\"><a class=\"table-link\" href = \"https://joaoarthurbm.github.io/eda/posts/insertion-sort/\">Insertion Sort</a></th><th scope=\"col\"><a class=\"table-link\" href = \" https://pt.wikipedia.org/wiki/Shell_sort\">Shell Sort</a></th><th scope=\"col\"><a class=\"table-link\" href = \" https://pt.wikipedia.org/wiki/Quick_sort\">Quick Sort</a></th><th scope=\"col\"><a class=\"table-link\" href = \" https://pt.wikipedia.org/wiki/Heap_sort\">Heap Sort</a></th></tr></thead><tbody>");
}
...
void section_html(void){
    ...
    fprintf(html_arq, "<p class=\"card-text\">O <a class=\"link-algoritmo\"href=\"https://github.com/beatrizsiq/time-sorting-algorithms\">algoritmo</a> est� realizando a leitura de outro arquivo com n�meros inteiros e alocando-os em um vetor, para que seja realizada a ordena��o com os m�todos supracitados. Ap�s isso, foi gerado este arquivo HTML para impress�o do tempo de execu��o de cada m�todo.</p><p>Tecnologias utilizadas: Linguagem C, HTML, CSS e Bootstrap!</p><p>Trabalho para a disciplina de Ordena��o e Pesquisa.</p></div></div></div></section>");
	...
	fprintf(html_arq, "<div class=\"col-12 py-2 mt-3 text-left\"><p>Ol�, me chamo Beatriz Siqueira! Estou no 3� Per�odo do curso de Sistemas de Informa��o. Atualmente trabalho com suporte e desenvolvimento em banco de dados Oracle</p><p>Estudando: PHP, JavaScript, HTML, CSS e Bootstrap!</p></div>");
